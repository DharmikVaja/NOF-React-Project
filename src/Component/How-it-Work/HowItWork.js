...
const HowItWork = () => {
  ...
  return (
    <>
      ...
      <Slider {...settings}>
        <section class="olympaid-section testimonial-section">
                    ...
                    >
                      <div>
                        <div className="how-work-box" tabindex="-1">
                          ...
                          <p>
                            To get started, simply click on the "Register Now"
                            button. You'll be prompted to select your region and
                            class of interest, allowing us to tailor our
                            offerings specifically to your needs.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    >
                      <div>
                        <div className="how-work-box" tabindex="-1">
                          ...
                          <p>
                            Once registered, you'll gain access to our
                            innovative assessments. Our unique approach combines
                            Animation-story and AI-based evaluations for
                            students from Nursery to KG 2 and AI-driven exams,
                            including math papers by Dr. RD Sharma, for grades 6
                            to 10. This ensures a comprehensive evaluation of
                    ...
                    >
                      <div>
                        <div className="how-work-box" tabindex="-1">
                          ...
                          <p>
                            After completing the assessments, our cutting-edge
                            AI technology generates detailed analysis reports.
                            These reports not only highlight your areas of
                            strength but also identify knowledge gaps, helping
                            us create a personalized learning plan just for you.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div>
                        <div className="how-work-box" tabindex="-1">
                          ...
                          <p>
                            ...
                            communication. We provide regular updates directly
                            to parents at every step of the journey, ensuring
                    ...
                    >
                      <div>
                        <div className="how-work-box" tabindex="-1">
                          ...
                          <p>
                            Armed with your analysis report, you can begin your
                            tailored learning journey. NOF offers engaging
                            resources, including interactive questions, voice
                            support for better understanding, and flexible
                            scheduling to accommodate your school and parent
                            commitments.
                          </p>
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="how-work-box" tabindex="-1">
                          ...
                          <p>
                            ...
                            international certificates from London, UK, adding a
                            global perspective to your educational achievements.
                          </p>
                        </div>
                      </div>
                    </div>

  ...
  return (
    <div>
      <select name="schoolCode" className="form-select form-dashuser3 " id="country-state">
        ...
        <option value="UAE631">UAE631 - Wise Indian Academy, Ajman</option>
        <option value="MR440">MR440 - Meridian Public School, Hyderabad</option>
        <option value="AP918">
          AP918 - International Delhi Public School, Amalapuram
        </option>
        <option value="BH973">BH973 - Bahrain Indian School, Bahrain</option>
        <option value="KA558">
          KA558 - National Public School, Kudlu, Bengaluru
        </option>
        <option value="BR398">BR398 - Junior 30, Ara</option>
        <option value="BR221">BR221 - Delhi World Public School, Patna</option>
        <option value="EDACY7-7127">EDACY7-7127 - Career Guide Academy </option>
        ...
        <option value="CG832">CG832 - Sri Sankara Vidyalaya, Bhilai</option>
        ...
        <option value="UAE139">UAE139 - Delhi Private School, Dubai</option>
        <option value="OR777">OR777 - International Others</option>
        <option value="UAE884">UAE884 - Pearl Wisdom School, Dubai</option>
        <option value="VH10301">VH10301 - VIBGYOR High, Vadodara</option>
        <option value="BDRYN282">
          BDRYN282 - RYAN INTERNATIONAL SCHOOL-ICSE, BARDOLI, SURAT
        </option>
        <option value="ORRYN866">
          ORRYN866 - RYAN International School, Olpad Road, Surat
        </option>
        <option value="VH10305">VH10305 - VIBGYOR High, Surat</option>
        ...
        <option value="VPRYN991">
          VPRYN991 - ST. XAVIER’S HIGH SCHOOL-CBSE, KOPARLI ROAD, VAPI
        </option>
        <option value="GJ785">GJ785 - Young &amp; Pro, Surat</option>
        <option value="VH10305A">VH10305A - VIBGYOR Kids, Surat</option>
        <option value="VH10301A">VH10301A - VIBGYOR Kids, Vadodara</option>
        <option value="DRRYN664">
          DRRYN664 - RYAN International School, Dumas Road, Surat
        </option>
        <option value="MEM1009">MEM1009 - The Millennium School, Surat</option>
        <option value="HR114">
          HR114 - Manav Rachna International School, Sector-21C, Faridabad
        </option>
        <option value="HR010">
          HR010 - Alpine Convent School, Sector-10, Gurugram
        </option>
        <option value="HR115">
          HR115 - Manav Rachna International School, Sector-14, Faridabad
        </option>
        <option value="HR111">
          HR111 - Manav Rachna International School, Sector-46, Gurugram
        </option>
        <option value="HR112">
          HR112 - Manav Rachna International School, Sector-51, Gurugram
        </option>
        <option value="HR156">
        ...
        <option value="APFA007">APFA007 - Apeejay School, Faridabad</option>
        <option value="HR242">
          HR242 - Alpine Convent School, Sector-38, Gurugram
        </option>
        <option value="HR099">
          HR099 - G.D. Goenka Signature School, Sohna Road, Gurugram
        </option>
        ...
        <option value="GGSEC031">
          GGSEC031 - RYAN INTERNATIONAL SCHOOL, SECTOR 31, GURUGRAM
        </option>
        <option value="HR854">
        ...
        <option value="GGSEC040">
          GGSEC040 - RYAN INTERNATIONAL SCHOOL, SECTOR-40, GURUGRAM
        </option>
        <option value="HR113">
        ...
        <option value="VH10904">VH10904 - VIBGYOR High, Gurugram</option>
        <option value="APCD306">APCD306 - Apeejay School, Charkhi Dadri</option>
        <option value="GGBSF369">
          GGBSF369 - RYAN INTERNATIONAL SCHOOL, SOHNA ROAD, GURUGRAM
        </option>
        <option value="HR222">
          HR222 - G.D. Goenka Public School, Sector- 10 A, Gurugram
        </option>
        ...
        <option value="VH15301">VH15301 - VIBGYOR High School, Hennur</option>
        <option value="VH15107">VH15107 - VIBGYOR High, Horamavu</option>
        <option value="MGRYN575">
          MGRYN575 - RYAN INTERNATIONAL SCHOOL, MANGALORE
        </option>
        <option value="BNRYN084">
          BNRYN084 - RYAN INTERNATIONAL SCHOOL-ICSE, BANNERGATTA, BENGALURU
        </option>
        <option value="BNRYN083">
          BNRYN083 - RYAN INTERNATIONAL SCHOOL-CBSE, BANNERGATTA, BENGALURU
        </option>
        <option value="KA771">
        ...
        <option value="KA213">KA213 - Nagarjuna Vidyaniketan, Bengaluru</option>
        <option value="KA944">
          KA944 - Podar International School, Tumkuru
        </option>
        <option value="VH15152">VH15152 - VIBGYOR High, Chokkanahalli</option>
        <option value="VH15111">VH15111 - VIBGYOR High, Electronic City</option>
        <option value="VH15116">VH15116 - VIBGYOR High, Kadugodi</option>
        <option value="VH15130">VH15130 - VIBGYOR High, Yelahanka</option>
        <option value="KDRYN560">
          KDRYN560 - RYAN INTERNATIONAL SCHOOL-ICSE, KUNDANAHALLI, BENGALURU
        </option>
        <option value="KA042">
        ...
        <option value="VH15103">VH15103 - VIBGYOR High, Haralur</option>
        <option value="VH15120">VH15120 - VIBGYOR High, Jakkur</option>
        <option value="VH15102">VH15102 - VIBGYOR High, Marathahalli</option>
        ...
        <option value="VH15139">VH15139 - VIBGYOR High, HSR Layout</option>
        <option value="VI15138">
          VI15138 - VIBGYOR Roots And Rise, Panathur
        </option>
        <option value="VI15134A">VI15134A - VIBGYOR Roots, Doddanekundi</option>
        <option value="VH15120A">VH15120A - VIBGYOR Kids, Jakkur</option>
        <option value="VH15107A">VH15107A - VIBGYOR Kids, Horamavu</option>
        <option value="KDRYN561">
          KDRYN561 - RYAN Global School-IB&amp;IGCSE, Bengaluru
        </option>
        <option value="VH15103A">VH15103A - VIBGYOR Kids, Haralur</option>
        <option value="VH15111A">
          VH15111A - VIBGYOR Kids, Electronic City
        </option>
        <option value="VH15139A">VH15139A - VIBGYOR Kids, HSR Layout</option>
        <option value="KA326">
          KA326 - Wings Montessori House of Children, Mysuru
        </option>
        <option value="VH15116A">VH15116A - VIBGYOR Kids, Kadugodi</option>
        <option value="VH15102A">
          VH15102A - VIBGYOR Kids, Marathahalli, Bengaluru
        </option>
        <option value="VH15301A">VH15301A - VIBGYOR Kids, Hennur</option>
        <option value="EDACY7-7293">
          EDACY7-7293 - PSBB Learning Leadership Academy, Bengaluru
        </option>
        ...
        <option value="KL231">KL231 - Ahdiya Pree School, Kerala</option>
        <option value="JJK631">
        ...
        <option value="KSIS588">KSIS588 - Smart Indian School, Kuwait</option>
        <option value="MP190">MP190 - Daly College, Indore</option>
        <option value="MP365">
        ...
        <option value="MP715">
          MP715 - Daffodils Smart School Pipliyamandi, Madhya Pradesh
        </option>
        <option value="MP119">
        ...
        <option value="MP212">MP212 - Sherringwood World School, Indore</option>
        <option value="JBRNG337">
          JBRNG337 - ST. XAVIER’S HIGH SCHOOL-ICSE, RATAN NAGAR ROAD, JABALPUR
        </option>
        <option value="MP444">
        ...
        <option value="MP992A">
          MP992A - The Emerald Heights International School, Indore
        </option>
        <option value="MP311">MP311 - The Millennium School, Indore</option>
        <option value="MP121">
        ...
        <option value="JBSNG482">
          JBSNG482 - ST. XAVIER’S HIGH SCHOOL-ICSE, SHANTI NAGAR, JABALPUR
        </option>
        <option value="MP088">
        ...
        <option value="JBRYN631">
          JBRYN631 - RYAN INTERNATIONAL SCHOOL-CBSE, DAMOH NAKA, JABALPUR
        </option>
        <option value="RAM22">RAM22 - RAM Individual School</option>
        <option value="MP992B">
        ...
        <option value="EDACY7-7221">
          EDACY7-7221 - Nehru Montessori Sr Secondary School, Burhanpur
        </option>
        <option value="EDACY6-6213A">EDACY6-6213A - Happy Kids, Parasia</option>
        ...
        <option value="VH10108">VH10108 - VIBGYOR High, Airoli</option>
        <option value="VI10216">VI10216 - VIBGYOR Rise, Chinchwad</option>
        <option value="VH10103">VH10103 - VIBGYOR High School, Goregaon</option>
        <option value="VH10107">VH10107 - VIBGYOR High, Malad East</option>
        <option value="VI10117">VI10117 - VIBGYOR Rise, Malad West</option>
        <option value="VI11106">VI11106 - VIBGYOR Rise, Nashik</option>
        <option value="VI10225">VI10225 - VIBGYOR Rise, Wagholi</option>
        <option value="VH10211">VH10211 - VIBGYOR High, Yerwada</option>
        <option value="APKH210">APKH210 - Apeejay School, Kharghar</option>
        <option value="KERYN556">
          KERYN556 - RYAN INTERNATIONAL SCHOOL-CBSE, THAKUR COMPLEX, KANDIVALI
          EAST
        </option>
        <option value="NGHRD010">
          NGHRD010 - ST. XAVIER'S HIGH SCHOOL, MIDC, HINGNA ROAD, NAGPUR.
        </option>
        <option value="MWCBSE427">
          MWCBSE427 - RYAN INTERNATIONAL SCHOOL-CBSE, LINKING ROAD, MALAD WEST
        </option>
        <option value="ANRYN223">
          ANRYN223 - RYAN SHALOM-ICSE, POONAM NAGAR, ANDHERI
        </option>
        <option value="MWICSE426">
          MWICSE426 - RYAN INTERNATIONAL SCHOOL-ICSE, VASTU PARK, MALAD WEST
        </option>
        <option value="NVRYN952">
          NVRYN952 - RYAN Christian School-ICSE, Vashi, Navi Mumbai
        </option>
        <option value="MH101">
        ...
        <option value="MH779B">
          MH779B - Wisdom High International School, Govardhan Campus, Nasik
        </option>
        <option value="MH927">MH927 - Elpro First Steps, Pune</option>
        <option value="VH10112">VH10112 - VIBGYOR High, Borivali</option>
        <option value="VI11003">
          VI11003 - VIBGYOR Roots And Rise, Kalyan
        </option>
        <option value="VH10404">VH10404 - VIBGYOR High, Kolhapur</option>
        <option value="PURYN151">
          PURYN151 - RYAN International School-ICSE, Bavdhan Road, Pune
        </option>
        <option value="NGHWN011">
          NGHWN011 - St. Xavier’s High School, Hiwri Nagar, Nagpur
        </option>
        <option value="NSRYN444">
          NSRYN444 - RYAN INTERNATIONAL SCHOOL-ICSE, TAGORE NAGAR, NASHIK
        </option>
        <option value="NVRYN959">
          NVRYN959 - RYAN Shalom Montessori-ICSE, Ulwe, Navi Mumbai
        </option>
        <option value="MH978">
          MH978 - Bhavans B P Vidya Mandir, Ashti, Nagpur
        </option>
        <option value="MH525">MH525 - Olympiad Center, Bhusawal</option>
        <option value="MH872">
        ...
        <option value="MH779A">
          MH779A - Wisdom High International School, Rameshwar Nagar, Nasik
        </option>
        <option value="MH111">MH111 - Disney Kids Preschool, Pune</option>
        <option value="MH800">
          MH800 - Saplings Pre-School &amp; Activity Center
        </option>
        <option value="MH246">
          MH246 - Kangaroo Kids International Preschool, Pimple Saudagar
        </option>
        <option value="VH10215">VH10215 - VIBGYOR High, Hinjewadi</option>
        <option value="VH10116">VH10116 - VIBGYOR High, Kharghar</option>
        <option value="VH10207">VH10207 - VIBGYOR High, Magarpatta</option>
        <option value="APNE706">APNE706 - Apeejay School, Nerul</option>
        <option value="NVKRG902">
          NVKRG902 - RYAN International School-ICSE, Kharghar, Navi Mumbai
        </option>
        <option value="OJRYN777">
          OJRYN777 - RYAN INTERNATIONAL SCHOOL-CBSE, OJHAR, NASIK
        </option>
        <option value="NVNRL901">
          NVNRL901 - RYAN INTERNATIONAL SCHOOL-ICSE, NERUL, NAVI MUMBAI
        </option>
        ...
        <option value="PURYN152">
          PURYN152 - RYAN International Academy-CBSE, Bavdhan Road, Pune
        </option>
        <option value="CMRYN121">
          CMRYN121 - RYAN INTERNATIONAL SCHOOL-ICSE, CHEMBUR
        </option>
        <option value="NVRYN956">
          NVRYN956 - RYAN INTERNATIONAL SCHOOL-CBSE, SANPADA, NAVI MUMBAI
        </option>
        <option value="MH266">
        ...
        <option value="VH10206">VH10206 - VIBGYOR High, Balewadi</option>
        <option value="VI10220">VI10220 - VIBGYOR Rise, Fursungi</option>
        <option value="VH10202">VH10202 - VIBGYOR High, NIBM</option>
        <option value="VI10224">
          VI10224 - VIBGYOR Rise, Pimpale Saudagar
        </option>
        <option value="KERYN555">
          KERYN555 - CAMBRIDGE SCHOOL-ICSE, THAKUR COMPLEX, KANDIVLI EAST
        </option>
        <option value="RGCBSE666">
          RGCBSE666 - St.Joseph High School-CBSE, New Panvel
        </option>
        <option value="NVRYN954">
          NVRYN954 - RYAN SHALOM KAMOTHE-CBSE, KAMOTHE, NAVI MUMBAI
        </option>
        ...
        <option value="MH882">MH882 - Munchkids Preschool, Mumbai</option>
        ...
        <option value="VH10202A">VH10202A - VIBGYOR Kids, NIBM</option>
        <option value="EDACY6-6242">
          EDACY6-6242 - SPG International School, Chinchwad
        </option>
        <option value="VI11106A">VI11106A - VIBGYOR Roots, Nashik</option>
        <option value="VH10112A">VH10112A - VIBGYOR Kids, Borivali</option>
        <option value="MH768">
          MH768 - Gundecha Education Academy, Kandivali East
        </option>
        <option value="VI10220A">VI10220A - VIBGYOR Roots, Fursungi</option>
        <option value="MH900">
          MH900 - J Kumar International School, Mumbai
        </option>
        <option value="ABC504">ABC504 - ABC Kids Convent, Shirpur Jain</option>
        <option value="DES001">
          DES001 - Daimond English School, Aurangabad
        </option>
        <option value="DHS075">DHS075 - Dnyanmandir High School, Mumbai</option>
        <option value="JSP404">JSP404 - J S Public School, Manora</option>
        <option value="KDE202">
          KDE202 - Kranti Dnyanpeeth English School, Ashti
        </option>
        <option value="LKE103">LKE103 - L K English Medium School, Arni</option>
        <option value="LME097">
          LME097 - Little Mary English School, Mumbai
        </option>
        <option value="LSP301">
          LSP301 - Lt Sundarabai Pampattiwar English Medium School, Yavatmal
        </option>
        <option value="NSA002">NSA002 - Navkar School, Aurangabad</option>
        <option value="PBS521">
          PBS521 - Pandit Babarao Sabnis English School, Nilanga
        </option>
        <option value="PJN906">
          PJN906 - Pandit Jawaharlal Nehru Central Public School, Bhandara
        </option>
        <option value="UDE311">
        ...
        <option value="VH10206A">VH10206A - VIBGYOR Kids, Balewadi</option>
        <option value="VI10224A">
          VI10224A - VIBGYOR Roots, Pimple Saudagar
        </option>
        <option value="VH10103A">VH10103A - VIBGYOR Kids, Goregaon</option>
        <option value="EDACY7-7328">EDACY7-7328 - The World School</option>
        <option value="VH10107A">VH10107A - VIBGYOR Kids, Malad East</option>
        <option value="VI10216A">VI10216A - VIBGYOR Roots, Chinchwad</option>
        <option value="AES708">
        ...
        <option value="DDS612">DDS612 - Dew Drops School, Diva</option>
        <option value="DEM701">
          DEM701 - Dnyandeep English Medium School, Mangrul Dastgir
        </option>
        <option value="DRJ057">
        ...
        <option value="SPS601">
          SPS601 - Shivdarshan Primary Sec. and Hr. Sec. School, Nanduri
        </option>
        <option value="SVD008">
          SVD008 - Smt Vimal Dr Laxminarayan Soni Eng School And Jr College,
          Nagpur
        </option>
        <option value="VCD105">VCD105 - Vandana Convent, Digraj</option>
        <option value="WPE504">
          WPE504 - Wartan Primary English School, Mantha
        </option>
        <option value="MTSE23">MTSE23 - MESTA Individual Schools</option>
        <option value="THNSW755">
          THNSW755 - RYAN INTERANATIONAL SCHOOL-CBSE, NALLASOPARA WEST, THANE
        </option>
        <option value="BWRYN752">
          BWRYN752 - RYAN CHRISTIAN SCHOOL-ICSE, BORIVLI WEST, Mumbai
        </option>
        <option value="NGRYN212">
          NGRYN212 - ST. XAVIER’S KINDERGARTEN SCHOOL-CBSE, AJNI, NAGPUR
        </option>
        <option value="MH480">
          MH480 - Army Pre Primary School, Khadakwasla, Pune
        </option>
        <option value="EDACY7-7280">
          EDACY7-7280 - Sparkles International School, Alandi Dewachi&nbsp;
        </option>
        <option value="VH10207A">VH10207A - VIBGYOR Kids, Magarpatta</option>
        <option value="VH10404A">VH10404A - VIBGYOR Kids, Kolhapur</option>
        ...
        <option value="MCW911">MCW911 - Model Convent, Wadegaon</option>
        <option value="MPN204">
        ...
        <option value="SCB105">SCB105 - Shree Convent, Bitoli</option>
        <option value="SKB904">
          SKB904 - Smt. Kamalabai B Taori Bahu Uddeshiya Shikshan Sanstha,
          Nagpur
        </option>
        <option value="SPI406">
        ...
        <option value="SRG066">
          SRG066 - Shri Ratanshi Gordhandas Bajaria Eng Med Pri School, Borivali
        </option>
        <option value="SSN122">SSN122 - Siddhivinayak School, Nagpur</option>
        <option value="SVD402">SVD402 - Sunrise Vidhyalay, Dhanora</option>
        <option value="VCM224">VCM224 - Vidyamandir Convent, Mul</option>
        ...
        <option value="VH10116A">VH10116A - VIBGYOR Kids, Kharghar</option>
        <option value="VI10117A">VI10117A - VIBGYOR Roots, Malad West</option>
        ...
        <option value="DAC401">DAC401 - Dnyanodaya Academy, Chandrapur</option>
        <option value="JPS010">
          JPS010 - Jhonson Preparatory School, Kolhapur
        </option>
        <option value="KEM429">KEM429 - KEM High School, Mumbai</option>
        <option value="KRP412">KRP412 - K R Public School, Nandurbar</option>
        <option value="LVM072">
          LVM072 - Lokmanya Vidya Mandir English Sec. Section, Mumbai
        </option>
        <option value="PEM203">
        ...
        <option value="DL041">DL041 - The Mann School, Delhi</option>
        <option value="SJ567">
          SJ567 - St. Mark's Senior Secondary Public School, New Delhi
        </option>
        <option value="SJ684">SJ684 - Bal Bharati Public School, Dwarka</option>
        <option value="APPP034">APPP034 - Apeejay School, Pitampura</option>
        <option value="RNSEC112">
          RNSEC112 - RYAN INTERNATIONAL SCHOOL, ROHINI, G2, NEW DELHI
        </option>
        <option value="DL059">
        ...
        <option value="RNSEC113">
          RNSEC113 - RYAN INTERNATIONAL SCHOOL, ROHINI, H3, NEW DELHI
        </option>
        <option value="DL362">
        ...
        <option value="DL314">DL314 - St. Columba's School, New Delhi</option>
        <option value="SJ453">SJ453 - Hillwoods Academy, New Delhi</option>
        <option value="APSA017">APSA017 - Apeejay School, Saket</option>
        <option value="RNSEC025">
          RNSEC025 - RYAN INTERNATIONAL SCHOOL, ROHINI, SECTOR-25, NEW DELHI
        </option>
        <option value="MVDL096">
          MVDL096 - RYAN International School, Mayur Vihar
        </option>
        <option value="VKDL070">
          VKDL070 - RYAN INTERNATIONAL SCHOOL, VASANT KUNJ, NEW DELHI
        </option>
        ...
        <option value="NG917">NG917 - Indian Language School, Nigeria</option>
        <option value="OD208">
          OD208 - Lajpat Rai Dav Public School, Cuttack{" "}
        </option>
        <option value="EDACY1-2033">
          EDACY1-2033 - Bhubaneswar Model Public School, Bhubaneswar
        </option>
        <option value="MH878">MH878 - Wisdom World School, Hadapsar</option>
        <option value="PB117">
        ...
        <option value="APMM001">APMM001 - Apeejay School, Mahavir Marg</option>
        <option value="APMT001">APMT001 - Apeejay School, Model Town</option>
        <option value="APTR001">APTR001 - Apeejay School, Tanda Road</option>
        <option value="PTRYN147">
          PTRYN147 - RYAN International School, Patiala
        </option>
        <option value="APRM007">APRM007 - Apeejay School, Rama Mandi</option>
        <option value="NKJLN426">
          NKJLN426 - RYAN International School, Nakodar, Jalandhar
        </option>
        <option value="MEM1008">MEM1008 - The Millennium School, Mohali</option>
        ...
        <option value="PB000">PB000 - Delhi Public School, Rajpura</option>
        <option value="DGRYN879">
          DGRYN879 - RYAN International School, Dugri, Ludhiana
        </option>
        <option value="PJ329">PJ329 - British Columbia School, Rupnagar</option>
        <option value="MEM1002">MEM1002 - The Millennium School, Sunam</option>
        ...
        <option value="RJ105">RJ105 - Delhi Public School, Udaipur</option>
        ...
        <option value="RJ109">RJ109 - Neo Learning School, Padampur</option>
        <option value="RJ282">
          RJ282 - Jayshree Periwal Global School, Jagatpura, Jaipur
        </option>
        ...
        <option value="RJ707">RJ707 - IPA Institute, Ajmer</option>
        ...
        <option value="EDACY6-6099">EDACY6-6099 - SS Mody Vidya Vihar</option>
        <option value="UAE097">
          UAE097 - New Delhi Private School, Sharjah
        </option>
        <option value="UAE082">UAE082 - Delhi Private School, Sharjah</option>
        <option value="TN938">
          TN938 - Redeemer Talent Academy, Tamil Nadu
        </option>
        <option value="VH15701">VH15701 - VIBGYOR High, Coimbatore</option>
        ...
        <option value="VH15701A">VH15701A - VIBGYOR Kids, Coimbatore</option>
        ...
        <option value="TN474">TN474 - Army Public School, Chennai</option>
        <option value="TS057">
        ...
        <option value="TG214">TG214 - Joyland School, Hyderabad</option>
        <option value="TS200">
          TS200 - Glendale International School Cambridge, Telangana
        </option>
        ...
        <option value="EDACY6-6185">EDACY6-6185 - Indian Public School</option>
        <option value="UP602">UP602 - Ramagya School, Greater Noida</option>
        <option value="UP484">
          UP484 - St. Xaviers High School, Ghaziabad
        </option>
        <option value="VH10503">VH10503 - VIBGYOR High, Lucknow</option>
        ...
        <option value="UP861">UP861 - Raghav Global School, Noida</option>
        <option value="UP209">UP209 - Ramagya School, Noida</option>
        <option value="NORYN301">
          NORYN301 - RYAN INTERNATIONAL SCHOOL, NOIDA
        </option>
        <option value="APNO301">APNO301 - Apeejay School, Noida</option>
        ...
        <option value="UP862">UP862 - Aspam Scottish School, Noida</option>
        <option value="UP153">UP153 - Ramagya School, Dadri</option>
        <option value="UP670">
        ...
        <option value="MEM1007">MEM1007 - Millennium World School, Orai</option>
        ...
        <option value="VH10503A">VH10503A - VIBGYOR Kids, Lucknow</option>
        ...
        <option value="UK123">UK123 - Delhi Public School, Dehradun</option>
        <option value="WB594">WB594 - Delhi Public School, Durgapur</option>
        <option value="WB116">WB116 - KidsTree Tamluk, West Bengal</option>
        <option value="WB300">
          WB300 - Delhi Public School, Ruby Park, Kolkata
        </option>
        <option value="WB428">WB428 - St. Anthony'S School, Jalpaiguri</option>
